  ...
  <<
    ...
    \new Staff {
      ...
      \relative c' {
        ...
        c8_"R" c_"..." c c c c c c | a' f d b f' d b g | c_"L" c_"..." c c c c c c | g b d f b, d f a | 
        a_"R" f_"..." d b f' d b g | a'16 f d b f' d b g a'16 f d b f' d b g | g8_"L" b_"..." d f b, d f a | g,16 b d f b, d f a g,16 b d f b, d f a | c4 r r2
        \bar "|." 
      }
    }
